...
public class E2JavaMethods {
    public static void main(String[] args) {
        // TODO: Step 1 - Create a method named `printNumbers` in Printer Class.
        // In the method body, use a loop (such as a for loop) to print numbers from 1 to 10, each on a new line.
