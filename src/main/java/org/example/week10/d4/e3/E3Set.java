...
public class E3Set {
    public static void main(String[] args) {
        ...
        // Initialize a LinkedHashSet<String> to store email addresses, which will preserve the order in which they were added and
        // ensure that duplicates are not stored.
        ...
        hashSet.add(null);
        hashSet.add("john.doe@example.com");
        hashSet.add("jane.smith@example.com");
        hashSet.add("john.doe@example.com");
        hashSet.add("admin@event.com");
        hashSet.add("info@company.com");
