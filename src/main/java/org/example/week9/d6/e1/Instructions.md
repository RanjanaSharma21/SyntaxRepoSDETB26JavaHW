...
1. **Create the `ElectronicDevice` interface** with the following:
...
1. **Create a `Smartphone` class** that implements the `ElectronicDevice` interface.
    - **Implement Methods:**
...
1. **Create a `Laptop` class** that implements the `ElectronicDevice` interface.
    - **Implement Methods:**
...
**Step 4: Test the Implementation in the `E1Interface` Class**

1. **In the `E1Interface.java` class**:
